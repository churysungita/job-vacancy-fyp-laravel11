                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <div class="m-b-25">
                                    <img src="{{ auth()->user()->profile_picture ? asset(auth()->user()->profile_picture) : asset('images/user-profile.png') }}" class="img-radius" alt="User-Profile-Image" style="width:150px">
                                </div>
                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400">{{auth()->user()->middle_name}}</h6>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400">{{auth()->user()->date_of_birth}}</h6>
                                    </div>
                                </div>
                            </div>
                            <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Contacts</h6>
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <p class="m-b-10 f-w-600">City/Region</p>
                                    <h6 class="text-muted f-w-400">{{auth()->user()->city_region}}</h6>
                                </div>
                                <div class="col-sm-4">
                                    <p class="m-b-10 f-w-600">Physical Address</p>
                                    <h6 class="text-muted f-w-400">{{auth()->user()->physical_address}}</h6>
                                </div>
                            </div>
